...
export interface System {
    ...
    security?: {
        module?: "auto" | "selinux" | "apparmor" | "none" | string;
    };
    kdump?: boolean;
...
export declare function parseDocument(jsonText: string): Document;
export declare function stringifyDocument(doc: Document): string;
